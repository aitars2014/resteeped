...
const BRANDS = {
  ...
  teahaus: {
    ...
    description: 'Ann Arbor tea shop and café offering over 170 loose leaf teas, traditional afternoon tea service, and tea education.',
    city: 'Ann Arbor',
    state: 'MI',
    country: 'United States',
    founded: 2010,
    specialty: ['Loose leaf tea', 'Afternoon tea', 'Tea education'],
  },
  teasource: {
    name: 'TeaSource',
    slug: 'teasource',
    url: 'https://www.teasource.com',
    description: 'Minnesota-based specialty tea retailer with 25+ years of experience, offering hundreds of loose leaf teas sourced directly from gardens worldwide.',
    city: 'St. Paul',
    state: 'MN',
    country: 'United States',
    founded: 1998,
    specialty: ['Loose leaf tea', 'Single origin', 'Direct sourcing'],
  },
  rishitea: {
    name: 'Rishi Tea',
    slug: 'rishi-tea',
    url: 'https://www.rishi-tea.com',
    description: 'Milwaukee-based organic tea company known for direct trade sourcing, botanical blends, and sparkling teas. Pioneer in organic and fair trade tea in the US.',
    city: 'Milwaukee',
    state: 'WI',
    country: 'United States',
    founded: 1997,
  ...
  looseleafteamarket: {
    ...
    description: 'Online tea marketplace specializing in high-quality loose leaf teas from around the world, with a focus on accessibility and education.',
    city: null,
    state: null,
    country: 'United States',
    founded: null,
    specialty: ['Loose leaf tea', 'Tea education', 'Variety'],
  },
  hackberrytea: {
    name: 'Hackberry Tea',
    slug: 'hackberry-tea',
    url: 'https://hackberrytea.com',
    description: 'Small-batch tea company offering thoughtfully sourced teas with a focus on quality and simplicity.',
    city: null,
    state: null,
    country: 'United States',
    founded: null,
    specialty: ['Small-batch', 'Curated selection', 'Quality focused'],
  },
  hugotea: {
    name: 'Hugo Tea',
    slug: 'hugo-tea',
    url: 'https://hugotea.com',
    description: 'Colorado-based tea company creating unique herbal blends inspired by the Rocky Mountain region, using locally foraged and organic ingredients.',
    city: null,
    state: 'CO',
    country: 'United States',
    founded: null,
    specialty: ['Herbal blends', 'Rocky Mountain inspired', 'Locally foraged'],
  },
  kilogramtea: {
    name: 'Kilogram Tea',
    slug: 'kilogram-tea',
    url: 'https://kilogramtea.com',
    description: 'Specialty tea company offering carefully curated single-origin teas and unique blends with a modern approach to tea culture.',
    city: null,
    state: null,
    country: 'United States',
    founded: null,
    specialty: ['Single-origin', 'Modern tea culture', 'Curated selection'],
  },
  metoliustea: {
    name: 'Metolius Tea',
    slug: 'metolius-tea',
    url: 'https://metoliustea.com',
    description: 'Oregon-based artisan tea company creating small-batch herbal blends inspired by the Pacific Northwest landscape.',
    city: null,
    state: 'OR',
    country: 'United States',
    founded: null,
    specialty: ['Pacific Northwest', 'Herbal blends', 'Small-batch'],
  },
  davidstea: {
    name: 'DAVIDsTEA',
    slug: 'davidstea',
    url: 'https://www.davidstea.com',
    description: 'Canadian specialty tea retailer offering 150+ exclusive loose leaf teas, from classic blends to innovative flavors. Known for creative seasonal collections.',
    city: 'Montreal',
    state: 'QC',
    country: 'Canada',
    founded: 2008,
    specialty: ['Flavored tea', 'Seasonal collections', 'Loose leaf', 'Creative blends'],
  },
  hempandtea: {
    name: 'Hemp & Tea Co',
    slug: 'hemp-and-tea-co',
    url: 'https://hempandteaco.com',
    description: 'Tea company blending premium loose leaf teas with hemp-derived CBD for a wellness-focused tea experience.',
    city: null,
    state: null,
    country: 'United States',
    founded: null,
    specialty: ['CBD tea', 'Wellness tea', 'Hemp-infused blends'],
  },
  camdentea: {
    name: 'Camden Tea Company',
    slug: 'camden-tea-company',
    url: 'https://camdentea.shop',
    description: 'London-based tea company offering premium loose leaf teas sourced from around the world.',
    city: 'London',
    state: null,
    country: 'United Kingdom',
    founded: null,
    specialty: ['Loose leaf tea', 'British tea culture'],
  },
  seventeahouse: {
    name: 'Seven Teahouse',
    slug: 'seven-teahouse',
    url: 'https://seventeahouse.com',
    description: 'Specialty tea shop focused on high-quality Chinese and Taiwanese teas.',
    city: null,
    state: null,
    country: 'United States',
    founded: null,
    specialty: ['Chinese tea', 'Taiwanese tea', 'Gongfu'],
  },
  nioteas: {
    name: 'Nio Teas',
    slug: 'nio-teas',
    url: 'https://nioteas.com',
    description: 'Direct-sourced premium Chinese teas with a focus on quality and authenticity.',
    city: null,
    state: null,
    country: 'United States',
    founded: null,
    specialty: ['Chinese tea', 'Direct sourced', 'Premium loose leaf'],
  },
  thechineseteashop: {
    name: 'The Chinese Tea Shop',
    slug: 'the-chinese-tea-shop',
    url: 'https://thechineseteashop.com',
    description: 'Specialist in authentic Chinese teas, teaware, and tea culture.',
    city: null,
    state: null,
    country: null,
    founded: null,
    specialty: ['Chinese tea', 'Teaware', 'Puerh', 'Oolong'],
  },
  wighttea: {
    name: 'Wight Tea Company',
    slug: 'wight-tea-company',
    url: 'https://wighttea.com',
    description: 'Isle of Wight tea company offering carefully selected loose leaf teas.',
    city: 'Isle of Wight',
    state: null,
    country: 'United Kingdom',
    founded: null,
    specialty: ['Loose leaf tea', 'British tea'],
  },
  white2tea: {
    name: 'white2tea',
    slug: 'white2tea',
    url: 'https://white2tea.com',
    description: 'Independent puerh and Chinese tea vendor based in China. Known for unique blends, creative branding, and high-quality aged and raw puerh teas.',
    city: null,
    state: null,
    country: 'China',
    founded: null,
    specialty: ['Puerh', 'Raw puerh', 'Ripe puerh', 'Chinese tea', 'Aged tea'],
  },
  whatcha: {
    name: 'What-Cha',
    slug: 'what-cha',
    url: 'https://what-cha.com',
    description: 'UK-based tea shop offering an extensive range of single-origin teas from over 30 countries. Known for excellent value and rare finds.',
    city: null,
    state: null,
    country: 'United Kingdom',
    founded: null,
    specialty: ['Single origin', 'Rare teas', 'Global sourcing', 'Oolong', 'Puerh'],
  },
  pathofcha: {
    name: 'Path of Cha',
    slug: 'path-of-cha',
    url: 'https://pathofcha.com',
    description: 'Premium Chinese and Taiwanese teas sourced directly from family farms. Focus on mindful tea practice and quality.',
    city: null,
    state: null,
    country: 'United States',
    founded: null,
    specialty: ['Chinese tea', 'Taiwanese tea', 'Gongfu', 'Oolong', 'Puerh'],
  },
  plumdeluxe: {
    name: 'Plum Deluxe',
    slug: 'plum-deluxe',
    url: 'https://www.plumdeluxe.com',
    description: 'Portland-based tea company crafting handmade loose leaf blends with a focus on community and connection.',
    city: 'Portland',
    state: 'OR',
    country: 'United States',
    founded: 2012,
    specialty: ['Handcrafted blends', 'Community', 'Loose leaf'],
  },
  ippodo: {
    name: 'Ippodo Tea',
    slug: 'ippodo-tea',
    url: 'https://www.ippodotea.com',
    description: 'Kyoto-based tea house with nearly 300 years of history, specializing in premium Japanese green teas including matcha, gyokuro, and sencha.',
    city: 'Kyoto',
    state: null,
    country: 'Japan',
    founded: 1717,
    specialty: ['Matcha', 'Gyokuro', 'Sencha', 'Japanese green tea'],
  },
  thefragrantleaf: {
    name: 'The Fragrant Leaf',
    slug: 'the-fragrant-leaf',
    url: 'https://www.thefragrantleaf.com',
    description: 'Specialty tea shop offering premium loose leaf teas from around the world.',
    city: null,
    state: null,
    country: 'United States',
    founded: null,
    specialty: ['Loose leaf tea', 'Premium teas'],
  },
  yunnansourcingus: {
    name: 'Yunnan Sourcing (US)',
    slug: 'yunnan-sourcing-us',
    url: 'https://yunnansourcing.us',
    description: 'US warehouse for Yunnan Sourcing, offering fast domestic shipping on Chinese teas, especially puerh and Yunnan specialties.',
    city: null,
    state: null,
    country: 'United States',
    founded: null,
    specialty: ['Puerh', 'Chinese tea', 'Yunnan teas', 'US shipping'],
  },
  arborteas: {
    name: 'Arbor Teas',
    slug: 'arbor-teas',
    url: 'https://www.arborteas.com',
    description: 'Organic and fair trade loose leaf teas packaged in backyard-compostable bags. Sustainability-focused since 2004.',
    city: 'Ann Arbor',
    state: 'MI',
    country: 'United States',
    founded: 2004,
    specialty: ['Organic', 'Fair trade', 'Sustainable packaging'],
  },
  teabox: {
    name: 'Teabox',
    slug: 'teabox',
    url: 'https://www.teabox.com',
    description: 'India-based premium tea brand sourcing directly from 150+ estates across Darjeeling, Assam, Nilgiri, and Nepal.',
    city: null,
    state: null,
    country: 'India',
    founded: 2012,
    specialty: ['Darjeeling', 'Assam', 'Nilgiri', 'Single estate'],
  },
};
...
function isTeaProduct(product) {
  ...
  const excludePatterns = [
    ...
    'tea starter', 'travel kit', 'tea of the month', 'tea bag holder',
    'tea bag holders', 'teabag holder', 'teabag holders', 'tea holder',
    'tea holders', 'cha he', 'digital tea scale', 'potholder',
